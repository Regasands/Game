...
@onready var name_card: Label = $VBoxContainer/Name
@onready var description_card: Label = $VBoxContainer/Description
@onready var boost_card: Label = $VBoxContainer/boost
